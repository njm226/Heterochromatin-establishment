...
with open('b_list_1x075_S250_standard_AtoU_UtoS.txt', 'rb') as F:
   b = pickle.load(F)
   
with open('state_g_1x075_standard_AtoU_UtoS Kopie.txt', 'rb') as F:
...
# # x and y values changed for UtoS!!!
...
plt.savefig("New_Standard_1x075_S250_AtoU_UtoS_50%.pdf")