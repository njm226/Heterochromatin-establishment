...
with open('b_list_full_S350_standard_AtoU_UtoS.txt', 'rb') as F:
   b = pickle.load(F)
   
with open('state_g_full_standard_AtoU_UtoS Kopie.txt', 'rb') as F:
...
plt.savefig("New_fig_full_S350_AtoU_UtoS_50%.pdf")