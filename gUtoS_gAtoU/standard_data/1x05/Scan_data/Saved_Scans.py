...
with open('b_list_1x05_S200_standard_AtoU_UtoS.txt', 'rb') as F:
   b = pickle.load(F)
   
with open('state_g_1x05_standard_AtoU_UtoS Kopie.txt', 'rb') as F:
...
plt.savefig("New_Standard_1x05_S200_AtoU_UtoS_50%.pdf")