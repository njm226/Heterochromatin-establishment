...
with open('b_list_1x_S120_standard_AtoU_UtoS.txt', 'rb') as F:
   b = pickle.load(F)
   
with open('state_g_1x_standard_AtoU_UtoS Kopie.txt', 'rb') as F:
...
plt.savefig("New_Standard_1x_S120_AtoU_UtoS_50%.pdf")