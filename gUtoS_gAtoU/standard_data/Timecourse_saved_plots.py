...
## save state_list
with open('cenH_small_1x.txt', 'rb') as F:
    cenH_total_small = pickle.load(F)

## save state_list
with open('cenH_m_1x.txt', 'rb') as F:
    cenH_total_m = pickle.load(F)

## save state_list
with open('cenH_large_1x.txt', 'rb') as F:
    cenH_total_large = pickle.load(F)
    
## save state_list
with open('cenH_max_1x.txt', 'rb') as F:
...
## save state_list
with open('EcoRV_small_1x.txt', 'rb') as F:
    EcoRV_total_small = pickle.load(F)
    
## save state_list
with open('EcoRV_m_1x.txt', 'rb') as F:
    EcoRV_total_m = pickle.load(F)
    
## save state_list
with open('EcoRV_large_1x.txt', 'rb') as F:
    EcoRV_total_large = pickle.load(F)
    
## save state_list
with open('EcoRV_max_1x.txt', 'rb') as F:
