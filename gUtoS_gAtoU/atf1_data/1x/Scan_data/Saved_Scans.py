...
with open('b_list_1x_S150_periodic_AtoU_UtoS_new.txt', 'rb') as F:
   b = pickle.load(F)
   
with open('state_g_1x_atf1_AtoU_UtoS_new.txt', 'rb') as F:
...
plt.savefig("Atf1_1x_S150_AtoU_UtoS_50%.pdf")