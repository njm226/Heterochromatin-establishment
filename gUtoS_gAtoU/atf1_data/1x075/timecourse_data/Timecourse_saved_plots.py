...
## save state_list
with open('cenH_small_1x075_gUtoM100_AtoU110_S55.txt', 'rb') as F:
    cenH_total_small = pickle.load(F)

## save state_list
with open('cenH_m_1x075_gUtoM100_AtoU110_S55.txt', 'rb') as F:
    cenH_total_m = pickle.load(F)

## save state_list
with open('cenH_large_1x075_gUtoM100_AtoU110_S55.txt', 'rb') as F:
    cenH_total_large = pickle.load(F)
    
## save state_list
with open('cenH_max_1x075_gUtoM100_AtoU110_S55.txt', 'rb') as F:
...
## save state_list
with open('EcoRV_small_1x075_gUtoM100_AtoU140_S55.txt', 'rb') as F:
    EcoRV_total_small = pickle.load(F)
    
## save state_list
with open('EcoRV_m_1x075_gUtoM100_AtoU140_S55.txt', 'rb') as F:
    EcoRV_total_m = pickle.load(F)
    
## save state_list
with open('EcoRV_large_1x075_gUtoM100_AtoU140_S55.txt', 'rb') as F:
    EcoRV_total_large = pickle.load(F)
    
## save state_list
with open('EcoRV_max_1x075_gUtoM7100_AtoU140_S55.txt', 'rb') as F:
...
ax1.fill_between(time, cenH_total_small, color='cyan')
...
plt.savefig("timecourse_big_1x075.pdf")
