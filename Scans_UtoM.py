...
#smaller steps
#X = [72,74,76,78,80,82,84,86,88,90,92,94,96,98,100,102,104,106,108,110] # list of all global rate S(A->U) values
#Y = [72,74,76,78,80,82,84,86,88,90,92,94,96,98,100,102,104,106,108,110] #and all local rate S(U->S) values
...
# with open ('state_g_1x.txt', 'rb') as F:
...
# save Timing list
with open('Timing_noise.txt', 'wb') as F:
...
# save Timing list
with open('b_list_noise.txt', 'wb') as F:
...
# plt.savefig("fig_SAU_S55_1x.pdf")
