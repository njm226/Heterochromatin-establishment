...
from UtoA_model import simple as ss
...
# save state_list
with open('cenH_small_SUS30.txt', 'wb') as F:
    pickle.dump(cenH_total_small, F)
    
# save state_list
with open('cenH_m_SUS30.txt', 'wb') as F:
    pickle.dump(cenH_total_m, F)
    
# save state_list
with open('cenH_large_SUS30.txt', 'wb') as F:
   pickle.dump(cenH_total_large, F)
    
# save state_list
with open('cenH_max_SUS30.txt', 'wb') as F:
...
# save state_list
with open('EcoRV_small_SUS30_1_x.txt', 'wb') as F:
    pickle.dump(EcoRV_total_small, F)
    
# save state_list
with open('EcoRV_m_SUS30_1_x.txt', 'wb') as F:
    pickle.dump(EcoRV_total_m, F)
    
# save state_list
with open('EcoRV_large_SUS30_1_x.txt', 'wb') as F:
    pickle.dump(EcoRV_total_large, F)
    
# save state_list
with open('EcoRV_max_SUS30_1_x.txt', 'wb') as F:
...
plt.savefig("timecourse_big_SUS30.pdf")
