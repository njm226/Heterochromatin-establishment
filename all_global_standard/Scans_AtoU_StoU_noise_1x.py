...
Y = [190,185,180,175,170] #and all local rate S(U->S) values
...
if mode == 1:
        # save state_list
    with open('state_g_1x_standard_AtoU_StoU_noise.txt', 'wb') as F:
...
if mode == 0:
    ...
    # save Timing list
    with open('b_list_1x_S60_standard_AtoU_StoU_noise.txt', 'wb') as F:
        pickle.dump(b_value_list, F)
