...
if mode == 0:
    ...
    X_Y=[[153,192,170, 1]]
    X_Y_sm=[[182, 192,170, 1]]
    X_Y_sl=[[191,192,170, 1]]
    X_Y_max=[[203,192,170, 1]]
...
if mode == 0:
    ...
    # save state_list
    with open('cenH_small_1x_gAtoU194.5_StoU170_S70.txt', 'wb') as F:
        pickle.dump(cenH_total_small, F)
        
    # save state_list
    with open('cenH_m_1x_gAtoU194.5_StoU170_S70.txt', 'wb') as F:
        pickle.dump(cenH_total_m, F)
        
    # save state_list
    with open('cenH_large_1x_gAtoU194.5_StoU170_S70.txt', 'wb') as F:
      pickle.dump(cenH_total_large, F)
        
    # save state_list
    with open('cenH_max_1x_gAtoU194.5_StoU170_S70.txt', 'wb') as F:
        pickle.dump(cenH_total_max, F)
    ...
    # save state_list
    with open('EcoRV_small_1x_gAtoU194.5_StoU170_S70.txt', 'wb') as F:
        pickle.dump(EcoRV_total_small, F)
        
    # save state_list
    with open('EcoRV_m_1x_gAtoU194.5_StoU170_S70.txt', 'wb') as F:
        pickle.dump(EcoRV_total_m, F)
        
    # save state_list
    with open('EcoRV_large_1x_gAtoU194.5_StoU170_S70.txt', 'wb') as F:
        pickle.dump(EcoRV_total_large, F)
        
    # save state_list
    with open('EcoRV_max_1x_gAtoU194.5_StoU170_S70.txt', 'wb') as F:
        pickle.dump(EcoRV_total_max, F)
...
if mode == 1:
    plt.savefig("timecourse_1x_gAtoU192_StoU170_S50.pdf")
