...
from MtoU import t_loop
import MtoU
import importlib
importlib.reload(MtoU)
import pandas as pd
...
#    loc = glo_loc[1]
    ...
    beta5 = 20*len(mt_region)#13.5*len(mt_region)#15*len(mt_region)#
    ...
    cenH_status_list, EcoRV_status_list, states, S_nucleosomes_cenH = t_loop(duration, mt_region, positions, rates, SAU)
