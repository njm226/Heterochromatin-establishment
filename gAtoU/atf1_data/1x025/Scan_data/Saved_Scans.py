...
# save Timing list
with open('Timing_1x025_S150.txt', 'rb') as F:
    Timing = pickle.load(F)
    
    
# save Timing list
with open('all_criteria_1x025_S150.txt', 'rb') as F:
    all_criteria = pickle.load(F)
    
# save Timing list
with open('Differences_1x025_S150.txt', 'rb') as F:
    Differences = pickle.load(F)

# save Timing list
with open('b_list_1x025_S150.txt', 'rb') as F:
   b = pickle.load(F)
...
plt.savefig("fig_1x025_S150.pdf")